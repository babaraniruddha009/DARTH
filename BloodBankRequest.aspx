<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BloodBankRequest.aspx.vb" Inherits="BloodBankRequest" %>
        ...
        <div style="background-size: cover;min-height:100vh;max-height:1300px; background-color: rgba(225,225,225,0.6);">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="BloodBankRequest.aspx""><b>Request</b></a>
            ...
            <div id="divBackground">
                        ...
                        <div id="divImage">
                         ...
                         <div style="width:200%" id="GridDiv">
                       
                        <asp:UpdatePanel ID="update1" runat="server">
                            <ContentTemplate>
                                 <asp:Timer ID="Timer1" runat="server" Interval="1000" Enabled="true" ontick="Timer1_Tick"></asp:Timer>
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="true" PageSize="10" DataKeyNames="ID" AllowSorting="true" Style="text-align: center" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" CellPadding="4" EmptyDataText="No Data Found." ForeColor="#333333" GridLines="None">
                                   ...
                                   <asp:TemplateField HeaderStyle-HorizontalAlign="Center" Visible="false" ItemStyle-HorizontalAlign="Center"  HeaderText="Date">
                                       
                                        <ItemTemplate>
                                            <asp:Label ID="ItemDeleteDate" runat="server" Text='<%#Eval("DeleteRequestTime") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     ...
                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Status">
                                      ...
                                      <asp:TemplateField HeaderText="">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="AcceptBtn" Visible="true" CommandName="Update"  runat="server">Accept</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <asp:TemplateField HeaderText="">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="CancelBtn" Visible="true" runat="server" CommandName="Delete">Decline</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
