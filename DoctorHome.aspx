<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DoctorHome.aspx.vb" Inherits="DoctorHome" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="background:url(Images/addiction-aid-bottle-356054.jpg) no-repeat center; background-size: cover; height: 100vh;" runat="server">
            <header runat="server">
             ...
             <section class="feature_area" style="margin: 5%">
                <div>
                    ...
                    <div class="row justify-content-end">
                        <div style="margin-right: 50%; margin-top: 60px;margin-left:10%">
                             <h1 style="color:rgba(0,0,0,0.7);font-size:50px"><b>WELCOME TO</b></h1>
                            <asp:Label runat="server" style="color:rgba(0,0,0,0.5)" Font-Size="40px" Font-Bold="true" ID="HospitalNameLbl"></asp:Label>
