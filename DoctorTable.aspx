<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DoctorTable.aspx.vb" Inherits="DoctorTable" %>
                ...
                <div id="content-wrapper" >
                    ...
                    <div class="container-fluid" >
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Hospital Registered</li>
                        </ol>
                        ...
                        <asp:UpdatePanel ID="update1" runat="server">
                            <ContentTemplate>
                                ...
                                <div style="width:250%;text-align:center">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Hospital Name">
                                        <EditItemTemplate>
                                            ...
                                            <asp:TextBox ID="EditHospitalName" runat="server" Text='<%#Eval("Hospital_Name") %>'></asp:TextBox>
                                        
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="ItemHospitalName" runat="server" Text='<%#Eval("Hospital_Name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Hospital Type">
                                        <EditItemTemplate>
                                            <asp:DropDownList ID="EditHospitalType" runat="server">
                                                <asp:ListItem Value="-1">Select Hospital Type</asp:ListItem>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="ItemHospitalType" runat="server" Text='<%#Eval("Hospital_Type") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Pincode">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="EditPincode" runat="server" Text='<%#Eval("Pincode") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="ItemPincode" runat="server" Text='<%#Eval("Pincode") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Latitude">
                                     ...
                                     <asp:TemplateField HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"  HeaderText="Doctor Name">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="EditDoctorName" Width="200px" runat="server" Text='<%#Eval("Doctor_Name") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="ItemDoctorName" runat="server" Text='<%#Eval("Doctor_Name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
