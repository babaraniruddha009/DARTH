<%@ WebHandler Language="VB" Class="BloodBankPieChartHandler" %>
...
Public Class BloodBankPieChartHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        Dim cmd As SqlCommand = New SqlCommand("spGetBloodBankNamesPieChartCity", con)
        cmd.CommandType = CommandType.StoredProcedure
        cmd.Parameters.AddWithValue("@term", term)
        con.Open()
        Dim rdr As SqlDataReader = cmd.ExecuteReader()
        While (rdr.Read())
            ListLocationNames.Add(rdr("BloodBank_Name").ToString())
        End While
