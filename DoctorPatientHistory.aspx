<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DoctorPatientHistory.aspx.vb" Inherits="DoctorPatientHistory" %>
            ...
            <div id="divBackground">
                ...
                <ol class="breadcrumb" style="background-color:rgba(225,225,225,1)">
                            ...
                            <li class="breadcrumb-item">
                                <asp:LinkButton runat="server"  ForeColor="Black" ID="DetailBtn">Delivered History</asp:LinkButton>
                            </li>
                            <li class="breadcrumb-item">
                                <asp:LinkButton runat="server"  ForeColor="#3366ff"  ID="RequestBtn">Canceled History</asp:LinkButton>
                        ...
                        <asp:UpdatePanel ID="update1" runat="server">
                            <ContentTemplate>
                                ...
                                <asp:GridView ID="GridView1" Visible="true" runat="server" AllowPaging="true" PageSize="10" DataKeyNames="ID" AllowSorting="true" Style="text-align: center" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" CellPadding="4" EmptyDataText="No Data Found." ForeColor="#333333" GridLines="None">
                                   ...
                                   <asp:TemplateField HeaderText="Delete">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="DeleteBtn" Visible="true" runat="server" CssClass="fas fa-trash-alt" CommandName="Delete"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="GridView2" Visible="false"  runat="server" AllowPaging="true" PageSize="10" DataKeyNames="ID" AllowSorting="true" Style="text-align: center" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" EmptyDataText="No Data Found." ForeColor="#333333" GridLines="None">
                                    <AlternatingRowStyle BackColor="White" />
