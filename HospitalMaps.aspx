<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HospitalMaps.aspx.vb" Inherits="HospitalMaps" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#SearchText').autocomplete({
                source: 'HospitalMapHandler.ashx'
            });
        });
    </script>
...
<body>
    <form id="form1" runat="server">
        <div>
                ...
                <ol class="breadcrumb" style="background-color:rgba(225,225,225,1);height:50px" >
                    ...
                    <div class="search_course_wrap" style="margin-top:-5px">
                        <div style="background-color: white;width:170%" class=" d-flex justify-content-between">
                            <asp:TextBox runat="server" type="text" Height="37px" BackColor="lightgray" placeholder="Search by Hospital Name / City." CssClass="form-control" ID="SearchText" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by Hospital Name / City.'"></asp:TextBox>
            ...
            <div id="Maps" style="margin-left: 20px; margin-right: 20px">
