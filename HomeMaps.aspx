<%@ Page Language="VB" AutoEventWireup="false" CodeFile="HomeMaps.aspx.vb" Inherits="HomeMaps" %>
...
<head runat="server">
    ...
    <title>www.DARTH.com/HomeMaps.aspx
    </title>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Index.aspx#AboutUs"><b>About</b></a>
                            </li>     
                            <li class="nav-item">
       ...
       <div style="background-color:rgba(225,225,225,0.6);padding-left:10px;padding-right:10px" runat="server">
            <div style="padding-top:20px;width:100%">
                ...
                <ol class="breadcrumb" style="background-color:rgba(225,225,225,1);height:50px" >
                            ...
                            <li class="breadcrumb-item">
                                <asp:Label runat="server" ForeColor="gray" ID="PageLbl">Home Maps</asp:Label>
                    ...
                    <div class="search_course_wrap" style="margin-top:-5px">
                        <div style="background-color: white;width:170%" class=" d-flex justify-content-between">
                            <asp:TextBox runat="server" type="text" Height="37px" BackColor="lightgray" placeholder="Search by BloodBank / City." CssClass="form-control" ID="SearchText" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search by BloodBank / City.'"></asp:TextBox>
            ...
            <div id="Maps" style="margin-top:-10px;margin-left: 10px; margin-right: 10px">
                ...
                <asp:ListBox ID="ListDesc" ItemType="string" Style="visibility: hidden; width: 2px; height: 2px" runat="server"></asp:ListBox>
